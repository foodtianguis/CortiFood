...
class _MiWidgetTarjeta extends State<MiWidgetTarjeta>
    with SingleTickerProviderStateMixin {
  AnimationController controller;
  Animation<double> _frontRotation;
  Animation<double> _backRotation;
  Gradient _backgroundGradientColor;
  Color _ColorTarjeta;
  ...
  LinearGradient backgroundGradientColor(){
    return LinearGradient(
      ...
      colors: <Color>[
        _ColorTarjeta.withOpacity(1),
        _ColorTarjeta.withOpacity(0.97),
        _ColorTarjeta.withOpacity(0.90),
        _ColorTarjeta.withOpacity(0.86),
      ],
    );
  }
  ...
  Widget getCardTypeIcon(String cardNumber) {
    ...
    setState(() {
      _ColorTarjeta = ColorTarjeta(cardNumber);
      _backgroundGradientColor = backgroundGradientColor();
    });
    return icon;
  }
