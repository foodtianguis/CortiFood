...
class miPago extends StatefulWidget {
  @override
  _miPago createState() => _miPago();
}

class _miPago extends State<miPago> {
  ...
  void initState() {
    ...
    super.initState();
    setState(() {
      _cardNumber = '5204 1695 7197 7191';
      _DateExpiret = '08/25';
      _CardNombre = 'Leobardo Rodriguez';
    });
                              ...
                              new Flexible(
                                ...
                                child: new DropdownButtonHideUnderline(
                                  child: new InputDecorator(
                                    ...
                                    /*child: new DropdownButton<CheckoutMethod>(value: _method,isDense: true,onChanged: (CheckoutMethod value) {
                                        if (value != null) {
                                          setState(() => _method = value);
                                        }
                                      },
                                      items: banks.map((String value) {
                                        return new DropdownMenuItem<CheckoutMethod>(value:_parseStringToMethod(value),child: new Text(value),);
                                      }).toList(),
                                    ),*/
                                  ),
                                ),
